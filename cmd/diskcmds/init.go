...
blkid <device_name> # Check information about a block device in linux
blkid -o value -s TYPE <device_name> # Check the filesystem type of the block device
mkfs -t ext4 <device_name> # CAREFUL - this formats a block device with the given filesystem type
			`)
		},
	}
